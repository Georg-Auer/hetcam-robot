...
# cv2.imshow(cv2.drawKeypoints(img1, keypoints1, None, (255, 0, 255)))
# cv2.imshow(cv2.drawKeypoints(img2, keypoints2, None, (255, 0, 255)))
# cv2.waitKey(0)
...
# cv2.imshow(cv2.drawKeypoints(img1, [keypoints1[m.queryIdx] for m in good], None, (255, 0, 255)))
# cv2.imshow(cv2.drawKeypoints(img2, [keypoints2[m.trainIdx] for m in good], None, (255, 0, 255)))
# cv2.waitKey(0)
